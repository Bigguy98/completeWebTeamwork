...
<html>
    ...
    <body>
      ...
      <div class="content-page">
						...
						<form  >
							...
							<div class="text-box" for="password">
								...
								<input type="password" name="password" id="password" placeholder="Password...">
                                                    ...
                                                    <input type="hidden" id="id" value="${idPerson}">
                                                    <button type="button" onclick="btnEdit()" >Edit Person</button>
						</form>
					</div>
        ...
        <script type="text/javascript" src="/template/js/admin/editPerson.js"></script>
    </body>
</html>
