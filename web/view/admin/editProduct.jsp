...
<html>
    ...
    <body>
								...
								<div class="form-right">
									...
									<div class="text-box">
										...
										<input type="file" name="image" id="image" placeholder="Image...">
                                                                    ...
                                                                    <button type="button" onclick="btnEdit()">Edit Product</button>
								</div>
							</div>
						</form>
					</div>
        ...
        <input type="hidden" value="${idProduct}" id="idProduct">

        <script type="text/javascript" src="/template/js/admin.js"></script>
        <script type="text/javascript" src="/template/js/jquery.min.js"></script>
        <script type="text/javascript" src="/template/js/admin/editProduct.js"></script>
